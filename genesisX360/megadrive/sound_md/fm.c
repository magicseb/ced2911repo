...
/* ---------- update one of chip ----------- */
void YM2612UpdateDacAndTimers(int num, INT16 *buffer, int length)
{
	int i;
	int dacout = FM2612[num].dacout >> 13;

	for( i=0; i < length ; i++ )
		buffer[i] = dacout;
}

void YM2612UpdateSynth(int num, INT16 **buffer, int length)
{
